...
namespace Linear.Core.Tests.Unit
{
    public class InMemoryEventRepositoryTests
    {
        ...
        public void Append_Success()
        {
            ...
            var data = new Event<string>(Guid.NewGuid(), DayOfWeek.Monday, "test");
        ...
        public void Append_Multiple_Success()
        {
            var id = Guid.NewGuid();
            var repository = new InMemoryEventRepository<string>();
            var data1 = new Event<string>(id, DayOfWeek.Monday, "test1");
            var data2 = new Event<string>(id, DayOfWeek.Tuesday, "test2");
            var data3 = new Event<string>(id, DayOfWeek.Wednesday, "test3");
            var data4 = new Event<string>(id, DayOfWeek.Thursday, "test4");
            var data5 = new Event<string>(id, DayOfWeek.Friday, "test5");
